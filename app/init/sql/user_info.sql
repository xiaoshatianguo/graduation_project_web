CREATE TABLE IF NOT EXISTS `user_info` (
  ...
  `phone` INT(11) DEFAULT '' comment '会员/认证师电话',
  ...
  `age` INT(2) DEFAULT 0 comment '会员/认证师年龄',
  `address` VARCHAR(255) DEFAULT 0 comment '会员/认证师地址',
  -- TODO: 这里需要更换默认值为默认头像
  ...
  `status` INT(11) DEFAULT 0 comment '会员/认证师账号状态 - 0 未激活 - 1 正常 - 2 禁用',
